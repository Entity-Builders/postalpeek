-- Relax the feed filter: remove the hard requirement for bilingual did_you_know.
-- The illustration_tags + bbox requirement stays (game mode needs them).
-- This immediately unlocks ~258 postcards (up from 2).
