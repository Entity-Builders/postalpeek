-- Fix: album postcards injected into feed should NOT be trip stops,
-- otherwise they appear as TripCovers and the user can't see the claim button.
...
BEGIN
  ...
  -- Step 1: Pick up to 2 random UNCLAIMED album postcards (NOT trip stops)
  SELECT ARRAY(
