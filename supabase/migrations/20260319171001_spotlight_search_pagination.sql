-- Add p_exclude_ids parameter to postalpeek_spotlight_search for pagination without offset
-- Retains ORDER BY random() by simply excluding already seen postcards.

CREATE OR REPLACE FUNCTION public.postalpeek_spotlight_search_v2(
  p_tags                       text[]  DEFAULT '{}',
