-- ============================================================================
-- Add lat/lng to postalpeek_get_album_detail RPC
-- The Globe Explorer needs coordinates to place markers on the globe
-- ============================================================================
...
BEGIN
  ...
  IF v_has_slots THEN
    -- SLOT-BASED: return full postcard data including lat/lng
  ...
  ELSE
    -- DYNAMIC: generate virtual slots from match_rules (unchanged, no lat/lng needed for now)
    WITH
    owned AS (
